...
function startGame() {
  ...
  for (let i = 0; i < shuffledDeck.length; i++) {
    ...
    addImage.setAttribute("src", "../images/level_2/" + shuffledDeck[i]);
...
function nextLevel() {
  window.location.pathname = "C:/Users/m-kalateh/Desktop/project - Copy/level3/level-3-memory-card-game.html";
}